...
Partial Public NotInheritable Class MachineDataChartOne
    Inherits Page
    Dim WithEvents _Timer As New DispatcherTimer
    ...
    Private _MachDataNext As ObservableCollection(Of MachineData)
    Public Property MachDataNext() As ObservableCollection(Of MachineData)
        Get
            Return _MachDataNext
        End Get
        Set(ByVal value As ObservableCollection(Of MachineData))
            _MachDataNext = value
        End Set
    ...
    Private Sub _Timer_Tick(sender As Object, e As Object) Handles _Timer.Tick
        MachData.RemoveAt(0)
        MachData.Add(MachDataNext(0))
        MachDataNext.RemoveAt(0)
        If MachDataNext.Count = 0 Then
            MachDataNext = New ObservableCollection(Of MachineData)(g2Data)
        End If
    End Sub
End Class